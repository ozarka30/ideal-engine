...
emp("emp.account_manager", "Account Manager", SAL, 2, 6, 100,
    [sales(110, name="Close Deal"), eff("economy", "stat", stat="income", subject=SELF, amount=2)],
...
], archetype="turtle", founder="founder.okada", note="Fight 7. The first Counsel the player meets. Loyalty that will not break in Month 1."))
