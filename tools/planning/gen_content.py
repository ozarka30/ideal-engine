...
balance = OD([
    ...
    ("bands", OD([
        ("archetypeVsField", [420, 580]), ("archetypeBandFromRound", 4),
        ("counterPair", [580, 750]),
        ("mirror", [470, 530]),
    ...
    ("invariants", [
        ...
        inv("inv.archetype_band", "No archetype dominates the field", "From round 4, when tier-2 staff arrive, each archetype's win rate against the field, mirror excluded, lies inside the band. Rounds 1-3 have only tier-1 staff and nothing that can hurt Sales, so they are exempt (D-87).",
            "each archetype vs field, round >= archetypeBandFromRound", "win rate permille", "in", [420, 580], "smoke+nightly", "fail", "PLANNING_PROMPT invariant 3"),
