...
public sealed class ContentDb
{
    ...
    public RuleSet RuleSetFor(long round)
    {
        ...
        return new RuleSet(
            ...
            RushMult: Rules.Time.RushMult,
            RegenMult: Rules.Time.RegenMult,
            LoyaltyBaseConstant: Rules.Loyalty.BaseCap.Constant,
            LoyaltyBasePerRound: Rules.Loyalty.BaseCap.PerRound,
            RegenBasePermille: Rules.Loyalty.RegenBasePermille,
            RegenInterval: Rules.Loyalty.RegenInterval,
            RegenSuppressWindow: Rules.Loyalty.RegenSuppressWindow,
            SuppressThresholdPermille: Rules.Loyalty.SuppressThresholdPermille,
            ScandalInterval: Rules.Scandal.Interval,
            ScandalPerStack: Rules.Scandal.PerStack,
            ScandalTransferPermille: Rules.Scandal.TransferPermille,
            CurseSelfCostPermille: Rules.Curse.SelfCostPermille,
            ...
            BurnoutOutputPenaltyPermille: burnout.OutputPenaltyPermillePerStack,
